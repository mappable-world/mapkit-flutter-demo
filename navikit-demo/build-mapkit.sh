...
cd "$ARCADIA_ROOT/maps/mobile/apps/public_repos/mappable/mapkit-flutter-demo/navikit-demo"
rm -Rf bundle
mkdir bundle
...
then
    ...
    mv bundle/out-android/mappable_maps bundle/mappable_maps
...
then
    ...
    if [ -n "$BUILD_ANDROID" ]; then
        mv bundle/out-ios/mappable_maps/ios/Classes bundle/mappable_maps/ios
        mv bundle/out-ios/mappable_maps/ios/Frameworks/* bundle/mappable_maps/ios/Frameworks
    else
        mv bundle/out-ios/mappable_maps bundle/mappable_maps
    fi
